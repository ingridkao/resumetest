...
//   shadowUrl: 'https://cdnjs.cloudflare.com/ajax/libs/leaflet/0.7.7/images/marker-shadow.png',
    // iconSize: [25, 41],
    // shadowSize: [41, 41]
    iconUrl: require('@/assets/images/cat.png'),
    iconSize: [25, 25],
    iconAnchor: [12, 41],
    popupAnchor: [1, -34]
})
...
export default {
    ...
    methods:{
        chnageSelect(){
            ...
            // 官方教學：https://leafletjs.com/examples/custom-icons/
            if(this.marker){
                this.map.removeLayer(this.marker)
            }
            //新增座標點並bind Popup訊息
            this.marker = L.marker([pos.PositionLat, pos.PositionLon],{ icon: blackIcon }).addTo(this.map).bindPopup(this.info.ScenicSpotName);
        },
        getData(){
            this.load= true
